...
def vazifa_va_funksiyalar(request):
    return render(request, 'vazifa_va_funksiyalar.html', context={})
def laboratoriya_va_bolimlar(request):
    return render(request, 'laboratoriya_va_bolimlar.html', context={})
def xorijiy_hamkorlik(request):
    return render(request, 'xorijiy_hamkorlik.html', context={})
